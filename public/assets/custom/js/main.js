...
$('#form-modal').on('show.bs.modal', function (event) {
    ...
    var width = button.data('modal-width');
    if (width) {
        //        console.log(width);
