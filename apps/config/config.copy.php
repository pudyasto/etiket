...
|
*/
$config['encryption_key'] = 'ervlf3ua5urumW1GMPOSzJjprTD51pyA';
...
$config['sess_cookie_name'] = 'oms_';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = 'tmp_sessions' ;// FCPATH . 'apps/cache/'; // 
...
if(isset($_SERVER["PHP_SELF"])){
  ...
  $exclude_url_arr = array('kcfinder');
...
$config['csrf_exclude_uris'] = array(
    'api/.*?',
    'assets/plugins/kcfinder/.*?',
    'assets/plugins/kcfinder/[\s\S]*',
);
